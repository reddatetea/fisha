...
def getKucun(caigous,pinmings,early_riqi):
    datas = []
    fname1 = r"F:\a00nutstore\008\zw08\原材料日报表2024-04-06.xlsx"
    kucun = pd.read_excel(fname1,'原材料日报表' ,usecols=[0, 1,9],skiprows=1)
    kucun_cailiao = kucun[kucun['结余']!=0]
