...
if choice:
    try :
     ...
     pass
#万一没有含量，最后才用计算的方法
result0 = result0.assign(content = np.where(result0.content.isin(['',0,np.nan]),np.where((result0.begin_ben + result0.ruku_ben) != 0,
                                 (result0.begin_ben + result0.ruku_ben) / (result0.begin_jian + result0.ruku_jian),
