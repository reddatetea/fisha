...
mail_user = "rightcwb"     # 用户名
#mail_pass = "LTjtcwb8008"  # 口令d992ebbd11c5d788
mail_pass = "d992ebbd11c5d788"  # 口令d992ebbd11c5d788
# 配置发件人、收件人信息
sender = 'rightcwb@sina.com' # 发件人邮箱
...
# yclyx原材料邮箱
yclyx = ['1175599535@qq.com', '471528579@qq.com', '616012311@qq.com', '173937271@qq.com']
# 密送邮箱列表
...
yclyxs = yclyx + msyx
# 产成品邮箱列表+密送列表+自己邮箱列表   #20220214取消发自己邮箱
...
def send_mail(message,shoujianrens):
    """
    发送邮件
    :param message: 消息对象
    :return: None
    ...
    try:
        ...
        smtpObj.sendmail(sender, shoujianrens, message.as_string()) # 发送邮件
        print("邮件发送成功")
...
if __name__ == "__main__":
    ...
    for filename in filenames:
        ...
        if searchCcp:
            yxtt = os.path.splitext(filename)[0]
            shoujianrens = ccpyx +wmbyx           #产成品邮箱+外贸部邮箱
            #for shoujianren in shoujianrens:
            message = message_config(file_path, filename, yxtt, shoujianrens)
            send_mail(message, shoujianrens)
            time.sleep(10)
