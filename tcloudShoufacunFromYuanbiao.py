...
点选最近一次收发存汇总表，将存放取文件夹中的销售订单进行汇总，作为当日出库数，并生成日报表，
此举用以应对来不及生单、审表却又要及时出日报表的需求
'''
import os
import datetime
import easygui
