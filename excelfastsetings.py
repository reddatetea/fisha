...
def setPrintArea(fname,sheetnames=None):        #打印区域设置
    wb = openpyxl.load_workbook(fname)
    if sheetnames ==None :
        sheetnames = wb.sheetnames
        msg = '请点选要设置打印区域的excel工作表'
        print(msg)
        sheetnames = easygui.multchoicebox(msg, title= '设置打印区域', choices=sheetnames)
...
def firstRowSeting(fname,sheetnames =None):        #首行设置、其它行设置
    wb = openpyxl.load_workbook(fname)
    if sheetnames == None:
        sheetnames = wb.sheetnames
        msg = '请点选要设置首行的工作表'
        print(msg)
        sheetnames = easygui.multchoicebox(msg, title='设置首行', choices=sheetnames)
    else:
        sheetnames = wb.sheetnames
    for sheetname in sheetnames:
        ws = wb[sheetname]
...
def yemei(fname,sheetnames=None):
    wb = openpyxl.load_workbook(fname)
    # print('现在设置页眉页脚')
    if sheetnames == None:
        sheetnames = wb.sheetnames
        msg = '设置页眉页脚'
        print(msg)
        sheetnames = easygui.multchoicebox(msg, title='设置页眉页脚', choices=sheetnames)
    else:
        sheetnames = wb.sheetnames
...
def fastseting(fname,sheetnames = None):
    setPrintArea(fname,sheetnames)
    firstRowSeting(fname,sheetnames)
    yemei(fname,sheetnames)
...
def main():
    ...
    os.chdir(path)
    sheetnames = None
    fname = setPrintArea(fname,sheetnames = None)
    fname = firstRowSeting(fname,sheetnames = None)
    yemei(fname,sheetnames = None)
