...
def  aoyunhui(fname,ws_name):
    ...
    jijuns_range2 = ws['G2:' + 'G{}'.format(max_row)]
    for row in jijuns_range2:
        for j in row:
...
def  main():
    ...
    ws_name = choice
    yundongyuans, guanjun_dic, yajun_dic, jijun_dic = aoyunhui(fname,ws_name)
