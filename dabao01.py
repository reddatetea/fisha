...
py_lst = ['bs4', 'docx', 'python-docx','easygui', 'matplotlib', 'numpy', 'openpyxl', 'pandas', 'pdfplumber', 'pyperclip',
                  'xlwings', 'xpinyin', 'yagmail']

choice1 = easygui.buttonbox(msg='请选择打包的环境',choices=['python38','python34','python311','anaconda'])
if choice1 == 'python38':
    ...
    dabao_pyinstall = r''
elif choice1 == 'anaconda':
    dabao_python = r'D:\anaconda\Scripts\pyinstaller.exe'
    dabao_pyinstall = ''
else :
...
daobao_lst = [dabao_python,dabao_pyinstall,upx_way,paichu,file_way,ico,tmpdir_way,pyfile]
