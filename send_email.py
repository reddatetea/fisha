...
mail_pass = "ebvgqdomyxirbabd"  # 口令

# 配置发件人、收件人信息
sender = '1142760803@qq.com' # 发件人邮箱
receivers = ['810020984@qq.com']  # 接收邮件，可设置为多个邮箱
...
def message_config():
    ...
    message['From'] = Header("Moersuo")  # 发件人
    #message['To']   = Header("斯文张", 'utf-8')  # 收件人
    message['To'] = Header("斯文张")  # 收件人
    ...
    xlsx = MIMEApplication(open(file_name, 'rb').read())  # 打开Excel,读取Excel文件
