'''
公司电脑，通过点选将要打包的脚本、图标，生成完整的打包命令，自动粘贴到剪贴板上
'''
...
choice1 = easygui.buttonbox(msg='请选择打包的环境', choices=['python38', 'python34'])
if choice1 == 'python38':
    dabao_python = r'D:\python38\python.exe'
    dabao_pyinstall = r'D:\python38\PyInstaller-3.6\pyinstaller.py'
