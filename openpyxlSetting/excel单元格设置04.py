...
# 设置页眉页脚
ws.oddFooter.center=_HeaderFooterPart('&[页码]/&[总页数]')
ws.oddFooter.right= _HeaderFooterPart('制表：张文伟  &[日期]')
ws.evenFooter.center = _HeaderFooterPart('&[页码]/&[总页数]')
ws.evenFooter.right = _HeaderFooterPart('制表：张文伟  &[日期]')
