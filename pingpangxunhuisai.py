...
def xunhuisai(fname,ws_name):
    ...
    for row in jijuns_range:
        for j in row:
            ...
            print(mat)
            print(mat.group(2))
            jijuns.append(mat.group(1))
            jijuns.append(mat.group(2))
...
def  main():
    ...
    fname = r'乒乓球{}历届巡回赛总决赛战绩.xlsx'.format(choice)
    ws_name = choice
    yundongyuans, guanjun_dic, yajun_dic, jijun_dic = xunhuisai(fname,ws_name)
