'''
用自己的qq邮箱810020984发送公司每日原材料、产成品、零配件日报表
...
mail_user = "810020984"  # 用户名
mail_pass = ""  # 口令
mail_pass = "nithuagagbdhbdgc"  # 口令
# 配置发件人、收件人信息
sender = '810020984@qq.com'  # 发件人邮箱
...
if __name__ == "__main__":
    ...
    for filename in filenames:
        ...
        if searchYcl:
            ...
            time.sleep(2)
            # shoujianren = msyx                  #单独发送一个邮箱，密送
            # # for shoujianren in shoujianrens:
            # message = message_config(file_path, filename, yxtt, shoujianren)
            # time.sleep(5)
            # send_mail(message, shoujianren)
