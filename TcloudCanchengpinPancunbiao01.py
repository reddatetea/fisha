...
tiaozheng_ruku_files = [i for i in dir_list if ('其他入库单' in i) and (os.path.splitext(i)[-1].lower() == '.xlsx') and (i.startswith('~$') != True)]
tiaozheng_ruku_files
#调整出库单汇总
tiaozheng_chuku_files = [i for i in dir_list if ('其他出库单' in i) and (os.path.splitext(i)[-1].lower() == '.xlsx') and (i.startswith('~$') != True)]
tiaozheng_chuku_files
...
data_tiaozheng_rukus
# data_tiaozheng_rukus.to_excel('调整入库汇总.xlsx')
#其他出库单汇总
...
result0['class05']  = result0['class05'].fillna(method='ffill')            #向下填充
